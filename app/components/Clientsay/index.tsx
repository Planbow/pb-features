        ...
        <div className="mx-auto max-w-2xl py-40 px-4s sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                ...
                <div className="lg:relative">
                    <Image src={'/assets/clientsay/startup.jpeg'} alt="avatar-image" width={400} height={150} className="hidden lg:block" mx-auto/>
                    <Image src={'/assets/clientsay/startup2.jpeg'} alt="avatar-image" width={400} height={150} className="hidden lg:block" mx-auto/>
